...
Use the `NEXT` link to enter the main page flow.
...
- `main page/startpage2.html`: login-style entry page.
...
- The contact forms are visual only and do not submit data to a server.
